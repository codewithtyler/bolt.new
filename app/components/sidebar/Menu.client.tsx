...
export function Menu() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 px-5 h-[var(--header-height)] flex items-center z-[999]">
        <a href="/" className="text-2xl font-semibold flex items-center">
          <span className="i-bolt:logo-text?mask w-[46px] inline-block text-white" />
        </a>
      </div>
      ...
      >
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          ...
          <div className="h-[calc(100vh-400px)] overflow-y-auto overflow-x-hidden pl-4 pr-5 pb-5">
